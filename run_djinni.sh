...
in="$base_dir/src/djinni/helloworld.djinni"
cpp_out="$base_dir/djinni_build/cpp"
jni_out="$base_dir/djinni_build/jni"
objc_out="$base_dir/djinni_build/objc"
java_out="$base_dir/djinni_build/java/com/reactar"

java_package="com.reactar"
...
# Build djinni
"$base_dir/src/deps/djinni/src/build"

[ ! -e "$temp_out" ] || rm -r "$temp_out"
"$base_dir/src/deps/djinni/src/run-assume-built" \
